...
<body>
    <div class="register-container">
        ...
        <p class="subtitle">Se requiere contraseña maestra</p>
        ...
        <div class="info-box">
            <strong>⚠️ Acceso Restringido:</strong> Para registrar un administrador, se requiere la contraseña maestra del sistema.
        </div>
        ...
        <form method="POST" action="{{ route('register.admin.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="password" id="admin_password" name="admin_password" required placeholder="Contraseña maestra">
                @error('admin_password')
                    <div class="error">{{ $message }}</div>
                @enderror
                <small style="color: #666; font-size: 12px; display: block; margin-top: 5px;">
                    Contraseña maestra requerida para crear cuenta de administrador
                </small>
            </div>

            <button type="submit" class="btn">Registrarse como Administrador</button>
        </form>
